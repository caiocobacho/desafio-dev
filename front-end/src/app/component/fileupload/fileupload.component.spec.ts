...
describe('Testing File Upload component', () => {
  ...
  it('should get upload title ->Processar dados CNAB', () => {
    const compiled = fixture.nativeElement;
    expect(compiled.querySelector('.upload-title').textContent).toContain('Processar dados CNAB');
  });
  ...
  it('should process data ', () => {
    ...
    fixture.detectChanges();
    expect(component.message).toEqual('Oops!! Nenhum dado foi encontrado.');
  });
  ...
  it('should upload data error message ', () => {
    ...
    expect(component.message).toEqual('Oops!! Ocorreu um erro ao enviar seu arquivo, tente novamente. ');
  });
  ...
  it('should get upload description -> Visualizar últimos dados processados', () => {
    const compiled = fixture.nativeElement;
    expect(compiled.querySelector('.upload-description').textContent).toContain('Visualizar últimos dados processados');
  });
